...
select
  ...
  '[
    ...
    {"id":"b3","name":"הגדרת Google Analytics ו-Search Console","desc":"התקנה וחיבור מלא של כלי המדידה.","value":400},
    {"id":"b4","name":"גיבוי ענן ראשוני","desc":"גיבוי מלא של האתר אחרי ההשקה.","value":350},
    {"id":"b5","name":"30 ימי תמיכה אחרי ההשקה","desc":"מענה לשאלות ותיקוני באגים קלים ללא עלות.","value":900}
  ]'::jsonb,
  '[
