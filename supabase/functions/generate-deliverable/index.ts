...
function briefPrompt(title: string, items: Item[], personasText: string, sitemap: any): string {
  ...
  return [
    ...
    "חשוב מאוד: את הקופי (הכותרות והטקסטים השיווקיים) אנחנו כותבים בעצמנו. אל תבקש מהלקוח קופי שיווקי: לא כותרות ראשיות, לא כותרות משנה, לא סלוגנים, לא טקסטי כפתורים, לא ניסוחים לאתר. בקש רק חומרי גלם ומידע עסקי אמיתי.",
