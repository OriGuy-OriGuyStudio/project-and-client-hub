...
export default function ClientReport() {
  ...
  const speedExplain =
    ...
    ps >= 50 ? `יש מקום לשפר את מהירות האתר${lcpNote}, ואני עובד על זה.` :
    `מהירות האתר דורשת שיפור${lcpNote}, וזה בטיפול אצלי.`;
  const speedBenefit = ps != null && ps >= 70
    ? "מבקרים לא מתייאשים ועוזבים, וגם גוגל אוהב אתרים מהירים ומדרג אותך גבוה יותר."
    : "שיפור המהירות ישמור על המבקרים באתר וישפר את הדירוג בגוגל, ואני על זה.";
  ...
  const uptimeExplain =
    ...
    "היו החודש כמה הפרעות בזמינות, ואני במעקב צמוד כדי לצמצם אותן.";
  const uptimeBenefit = up != null && up >= 99
    ? "הלקוחות שלך תמיד מוצאים אותך, בלי דלת סגורה ובלי הזדמנות שהולכת לאיבוד."
    : "אני עוקב אחרי הזמינות מסביב לשעון ומטפל בכל נפילה מיד.";
  ...
  const guards: { icon: typeof Zap; label: string; note: string }[] = [
    ...
    { icon: TrendingUp, label: "ניטור זמינות 24/7", note: "אני יודע על נפילה לפני שאתה, ומטפל מיד." },
