...
/** The published journey (single) for a project, for the client project page. */
export function usePublishedJourney(projectId: string | null | undefined) {
  return useQuery({
    queryKey: ["published-journey", projectId],
    enabled: !!projectId,
