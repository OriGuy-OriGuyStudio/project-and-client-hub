  ...
  return (
    ...
    >
      <p className="mb-4 text-sm text-muted-foreground">
        {gendered(
          profile?.gender,
          "כאן אתה ממלא ומעלה את החומרים שצריך לכל עמוד באתר. מה שתעלה נשמר אצלנו אוטומטית.",
          "כאן את ממלאת ומעלה את החומרים שצריך לכל עמוד באתר. מה שתעלי נשמר אצלנו אוטומטית."
        )}
      </p>
