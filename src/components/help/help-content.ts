...
export const helpSections: HelpSection[] = [
  ...
  {
    title: "השירות שלך",
    body: "לוח הניטור החי של האתר: מהירות וזמינות, אבטחה (בדיקות אנטי-בוט ואיומים שנחסמו), תעבורת האתר וגיבויים אוטומטיים, עם גרפים לאורך זמן. חלק מהמדדים זמינים בחבילות Pro ומעלה.",
...
export const faq: FaqItem[] = [
  ...
  {
    q: "מה זה 'השירות שלך'?",
    a: "לוח ניטור חי של האתר שלך: מהירות וזמינות, אבטחה (בדיקות אנטי-בוט ואיומים שנחסמו), תעבורה וגיבויים אוטומטיים, עם גרפים לאורך זמן. חלק מהמדדים זמינים בחבילות Pro ומעלה.",
  },
  {
...
export const clientTourSteps: TourStep[] = [
  ...
  },
  {
    ...
    title: "השירות שלך",
    description:
      "אם יש לך חבילת שירות, כאן חי לוח הניטור של האתר: מהירות, זמינות, אבטחה (בדיקות אנטי-בוט ואיומים שנחסמו), תעבורה וגיבויים אוטומטיים, בזמן אמת.",
  },
  {
    selector: '[data-tour="contact"]',
    title: "יצירת קשר",
...
export const clientStoreTourSteps: TourStep[] = [
  ...
  },
  {
    ...
    title: "הגשת הפניה",
    description:
      "ממלאים שם ופרטי קשר של עסק שיכול להתאים, ומקבלים קרדיט מיידי, ועוד קרדיטים כשהעסקה נסגרת.",
  },
  {
...
export const partnerHelpSections: HelpSection[] = [
  ...
  {
    title: "מעקב אחרי הלידים",
    body: "כל ליד מציג סרגל התקדמות לאורך השלבים (התקבל, ממתין לשיחת היכרות, שיחה בוצעה, הצעה נשלחה, הלקוח אישר, אושר לעבודה), כך שתמיד רואים איפה הוא עומד. ברגע שליד אושר לעבודה תקבל הכרזה עם העמלה הממתינה, וברגע שהכסף עובר, הכרזה עם זיקוקים.",
    selector: '[data-tour="partner-leads"]',
  },
  {
...
export const partnerTourSteps: TourStep[] = [
  {
    selector: '[data-tour="nav"]',
    title: "תפריט הניווט",
    description: "מכאן מנווטים בין לוח הבקרה, העסקים שלך, הגשת ליד וחומרי המכירה.",
  },
  {
    selector: '[data-tour="partner-businesses"]',
    title: "העסקים שלי",
    description:
      "עסקים שאורי שייך אותך אליהם. במי שיש לך גישה לדשבורד השירות תראה גם את מצב האתר, הביצועים והגיבויים שלו.",
  },
  {
    selector: '[data-tour="new-lead"]',
    title: "הגשת ליד",
  ...
  },
  {
    ...
    title: "מעקב אחרי הלידים",
    description:
      "לכל ליד יש סרגל התקדמות לאורך השלבים. ברגע שהוא אושר לעבודה תקבל הכרזה עם העמלה הממתינה, וכשהכסף עובר, הכרזה עם זיקוקים.",
  },
  {
    selector: '[data-tour="referral-link"]',
    title: "לינק ההפניה",
...
export const clientWhatsNew: WhatsNewEntry[] = [
  ...
  {
    version: 3,
    title: "לוח הניטור של האתר שלך 📊",
    items: [
      'ב"השירות שלך": גרפים חיים של מהירות וזמינות לאורך זמן',
      "אבטחה: בדיקות אנטי-בוט ואיומים שנחסמו (בחבילות Pro ומעלה)",
      "תעבורת האתר וגיבויים אוטומטיים, במבט אחד",
    ],
  },
];
...
export const partnerWhatsNew: WhatsNewEntry[] = [
  ...
  {
    version: 3,
    title: "מעקב לידים חכם יותר 🚀",
    items: [
      "לכל ליד סרגל התקדמות: התקבל, שיחת היכרות, הצעה, אישור הלקוח, אושר לעבודה",
      'סטטיסטיקת "ממתין לתשלום", כל העמלות שנסגרו וטרם שולמו',
      "הכרזה כשליד אושר לעבודה, והכרזה עם זיקוקים ברגע שהעמלה משולמת",
    ],
  },
  {
    version: 4,
    title: "העסקים שלי 🏢",
    items: [
      "טאב חדש: העסקים שאורי שייך אותך אליהם",
      "בעסקים עם גישה לדשבורד השירות תוכל לצפות במצב האתר, בביצועים ובגיבויים, לצפייה בלבד",
      "הטאב הזה נפרד לגמרי מהגשת הלידים שלך",
    ],
  },
];
