    ...
    >
      ...
      <div className={`relative z-10 ${maxWidth} mx-auto w-full px-6`}>
        <div className="text-center">
          <h1
            className={`text-balance text-4xl font-bold leading-tight text-foreground sm:text-5xl sm:leading-tight md:text-6xl md:leading-tight lg:text-7xl lg:leading-tight xl:text-[80px] xl:leading-[1.1] mb-6 ${titleClassName}`}
            style={{ fontFamily, fontWeight }}
          >
            {title} <span className="text-primary">{highlightText}</span>
          </h1>
          <p
            className={`mx-auto mb-10 max-w-2xl text-pretty px-4 text-lg leading-relaxed text-white sm:text-xl ${descriptionClassName}`}
          >
            {description}
          </p>
          <button
